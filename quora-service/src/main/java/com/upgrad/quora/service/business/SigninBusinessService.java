...
public class SigninBusinessService {
    ...
    public UserAuthTokenEntity authenticate(final String username) throws AuthenticationFailedException {
        ...
        final String encryptedPassword = cryptographyProvider.encrypt(userEntity.getPassword(), userEntity.getSalt());
